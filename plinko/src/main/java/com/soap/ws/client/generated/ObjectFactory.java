...
public class ObjectFactory {
    ...
    private final static QName _GetRouteDepart_QNAME = new QName("http://tempuri.org/", "depart");
    private final static QName _GetRouteArrivee_QNAME = new QName("http://tempuri.org/", "arrivee");
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "depart", scope = GetRoute.class)
    public JAXBElement<String> createGetRouteDepart(String value) {
        return new JAXBElement<String>(_GetRouteDepart_QNAME, String.class, GetRoute.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "arrivee", scope = GetRoute.class)
    public JAXBElement<String> createGetRouteArrivee(String value) {
        return new JAXBElement<String>(_GetRouteArrivee_QNAME, String.class, GetRoute.class, value);
    }
