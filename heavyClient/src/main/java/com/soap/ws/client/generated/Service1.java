 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8090/IService1/Service1?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/IService1/Service1?wsdl");
    ...
    public IService1 getWSHttpBindingIService1() {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_IService1"), IService1.class);
    }
    ...
    public IService1 getWSHttpBindingIService1(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_IService1"), IService1.class, features);
    }
